    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="pt-4 border-t border-white/5">
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="radio" checked={role === "analyst"} onChange={() => setRole("analyst")} className="accent-[#14532d]" />
                <span className="text-sm text-white/80">Data Analyst</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="radio" checked={role === "admin"} onChange={() => setRole("admin")} className="accent-[#14532d]" />
          ...
          <button 
            type="submit"
            className="w-full py-3 mt-4 bg-gradient-to-r from-[#14532d] to-[#166534] text-white rounded-lg font-semibold hover:shadow-[0_0_20px_rgba(22,101,52,0.4)] transition-all duration-300"
          >
            Sign In to System
          </button>
        </form>
