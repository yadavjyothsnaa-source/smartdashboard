    ...
    <div id="login" className="w-full max-w-md mx-auto bg-black/20 backdrop-blur-xl border border-white/10 rounded-3xl p-10 shadow-2xl relative z-20">
      <div className="text-center mb-8">
        ...
        <div className="mt-3 p-3 bg-white/5 rounded-lg border border-white/10 text-xs text-white/50 text-left space-y-1">
          <p><strong className="text-[#166534]">Analyst:</strong> Jyothsna_DA_D1</p>
          <p><strong className="text-[#166534]">Admin:</strong> Rang_Ad_A1</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#166534]/50 transition-colors placeholder-white/20"
        ...
        <div>
          ...
          <input
            ...
            type="password"
            required
            className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#166534]/50 transition-colors"
            placeholder="••••••••"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={isPending}
          className="w-full py-3 bg-gradient-to-r from-[#14532d] to-[#166534] text-white rounded-lg font-semibold hover:shadow-[0_0_20px_rgba(22,101,52,0.4)] transition-all duration-300 disabled:opacity-50"
        >
