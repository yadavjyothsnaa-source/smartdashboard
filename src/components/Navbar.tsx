  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="px-5 py-2 text-sm font-semibold text-white bg-transparent border border-[#166534]/30 rounded-full hover:border-[#166534] hover:shadow-[0_0_15px_rgba(22,101,52,0.3)] transition-all duration-300"
      >
        Login / System
      </button>
    </motion.nav>
